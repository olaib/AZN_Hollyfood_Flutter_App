...
class _$DepartmentImpl implements _Department {
  const _$DepartmentImpl({this.uid = '', required this.name});
  ...
  @override
  String toString() {
    return 'Department(uid: $uid, name: $name)';
  }
  ...
  Map<String, dynamic> toDocument() {
    return _$$DepartmentImplToJson(this)..remove('uid');
  }
}

abstract class _Department implements Department {
  const factory _Department({final String uid, required final String name}) =
      _$DepartmentImpl;
